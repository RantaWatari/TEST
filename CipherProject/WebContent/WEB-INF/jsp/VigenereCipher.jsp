		...
		<div class="text">
			...
			<h3>2.暗号の仕組み ～ 暗号化と復号化</h3>
				...
				<h4>暗号化</h4>
					...
					<p>平文の最初の"H"は"K"に変換されています。これは鍵の"d"に対応しており、鍵の"d"はヴィジュネル暗号の３行目を用いて"H"を"K"に変換したのです（図.3）。
						同様に平文の"e"は鍵の"o"（ヴィジュネル方陣の１４行目）によって"s"に変換されて、平文の"l"は鍵の"g"（ヴィジュネル方陣の６行目）によって"r"変換されます。</p>

					<p>さて、鍵は"dog"の三文字ですが、二つ続く二文字目の"l"は何で変換されるでしょうか。鍵は平文の文字数に対して再利用されます。</p>
					<strong>ああ...なんと環境にやさしい暗号なのでしょう!!</strong><br><br>
					<p>"l"は鍵の"d"（ヴィジュネル方陣の1行目）によって"o"変換されます。暗号化の過程を確認してください（図.4）。</p>
